...
const ListProducts = [
  {
    ...
    ingredient: "100% Bột trà xanh matcha nguyên chất thu hoạch vụ Xuân - Không đường, sữa",
    color: "Xanh ngọc tự nhiên",
    smoothness: "Cao",
  ...
  {
    id: 2,
    src: ListImgProduct.yano[0],
    imgList: [ListImgProduct.yano],
    ingredient: "100% Bột trà xanh matcha nguyên chất thu hoạch vụ Xuân - Không đường, sữa.",
    color: "Xanh đậm",
    smoothness: "Cao",
    taste:"Thơm dịu, mùi lá trà tươi, đậm vị trà xanh, đắng ít, không chát",
    moreinfo: "",
    rate: 4.5,
  ...
  {
    id: 3,
    src:ListImgProduct.culi[0],
    imgList: [ListImgProduct.culi],
    ingredient: "100% Bột trà xanh matcha nguyên chất thu hoạch vụ Hè và vụ Thu - Không đường, sữa.",
    color: "Xanh tươi tự nhiên",
    smoothness: "Cao",
    taste:"Thơm mùi trà tự nhiên, ngậy nhẹ hấp dẫn, đắng nhẹ",
    moreinfo: "",
    rate: 5,
  ...
  {
    id: 5,
    src: ListImgProduct.jasmine[0],
    imgList: [ListImgProduct.jasmine],
    ingredient: "Trà xanh Matcha Special và hương hoa Nhài",
    color: " Màu xanh ngọc bích tự nhiên",
    smoothness: "Cao",
    taste:"Thơm mùi trà tự nhiên kết hợp hương hoa nhài dịu nhẹ, vị ngọt nhẹ tự nhiên, Độ se nhẹ từ catechin của trà cân bằng hoàn hảo vị ngọt từ các axit amin L-theanine",
  ...
  {
    id: 6,
    src: ListImgProduct.houjicha[0],
    imgList: [ListImgProduct.houjicha],
    ingredient: "100% Bột trà xanh nguyên chất rang - Không đường, sữa.",
    color: "Nâu đỏ",
    smoothness: "Cao",
    taste:"Có mùi hương đặc trưng của các loại thực vật sau khi rang, vị hơi giống như kẹo caramel",
  ...
  {
    id: 7,
    src: ListImgProduct.shiki[0],
    imgList: [ListImgProduct.shiki],
    ingredient: "100% Bột trà xanh matcha nguyên chất thu hoạch vụ Hè và vụ Thu - Không đường, sữa",
    color: "Xanh tươi tự nhiên",
    smoothness: "Cao",
    taste:"Thơm mùi trà tự nhiên, ngậy nhẹ hấp dẫn, ngọt nhẹ",
